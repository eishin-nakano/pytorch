...
class InstructionTranslatorBase(
    ...
    def prune_dead_locals(self):
        ...
        # allow `OutputGraph` to generate the proper `STORE DEREF`.
        #
        ...
        if self.output.side_effects.is_empty():
            ...
            def visit(var: VariableTracker):
                ...
                # NOTE we don't handle `InlinedClosureVariable` because the `STORE
                # DEREF` for these cells would've been generated by the parent
                # function, where these `InlinedClosureVariable` are represented as
                # `ClosureVariable`.
            ...
            non_cell_locals = [
                ...
                if name not in cellvars
            ]
            VariableTracker.visit(
                visit, (non_cell_locals, self.stack, self.output.backward_state)
            )
